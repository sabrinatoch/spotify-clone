...
import fr.codecake.spotify_clone.infrastructure.service.dto.State;
import fr.codecake.spotify_clone.infrastructure.service.dto.StatusNotification;
...
public class SongResource {
    ...
    public ResponseEntity<SongContentDTO> getOneByPublicId(@RequestParam UUID publicId) {
        ...
        return songContentByPublicId.map(ResponseEntity::ok).orElseGet(() -> ResponseEntity.of(ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, "UUID Unknown")).build());
    }
